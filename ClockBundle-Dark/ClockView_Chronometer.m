...
#import "ClockView_Dark.h"
#import "NSColor+CGColor.h"

@implementation ClockView_Dark

- (NSString *)title {
	return NSLocalizedString(@"Dark", @"Title of the clock view");
}

- (void)drawRect:(NSRect)dirtyRect {
	
	NSBundle *bundle = [NSBundle bundleWithIdentifier:@"de.pecora.iClock-ClockBundle-Dark"];
